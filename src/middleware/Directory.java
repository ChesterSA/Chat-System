...
public class Directory extends ChatNode
{
    ...
    /**
     * Constructor with string handle, along with the IP string of its connection.
     * @param handle Used to pair it with its connection around the system.
     * @param receiveIp 
     */ 
    ...
    /**
     * Constructor with string handle, string recieveIp, and the integer
     * port number.
     * of the directory.
    ...
    /**
     * Starts directory's ability to recieve new peer connections by starting
     * an instance of Thread acceptThread.
